            ...
            <StaggerContainer className="grid md:grid-cols-3 gap-8" staggerDelay={0.1}>
              ...
              <StaggerItem>
                <Card variant="pricing" className="h-full touch-feedback">
                  ...
                  <Link 
                    href="/dashboard"
                    className="btn-secondary w-full text-center touch-feedback"
                  >
                    Get Started Free
                  </Link>
                </Card>
              ...
              <StaggerItem>
                <Card variant="pricing" className="h-full touch-feedback">
                  ...
                  <button className="btn-secondary w-full text-center touch-feedback">
                    Contact Sales
                  </button>
                </Card>
              </StaggerItem>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <StaggerContainer className="space-y-4" staggerDelay={0.08}>
              {faqs.map((faq, idx) => (
                <StaggerItem key={idx}>
                  <Card variant="glass" className="hover:border-slate-600/50 transition-colors touch-feedback">
